...
import (
	...
	"umbra-c2/app/umbra-c2/internal/controller/c2"
...
var (
	Main = gcmd.Command{
		Name:  "umbra-c2",
		Usage: "umbra-c2",
		Brief: "Umbra C2 Server — Command & Control for Android Agents",
		Func: func(ctx context.Context, parser *gcmd.Parser) (err error) {
			...
			g.Log().Infof(ctx, "Umbra C2 Server starting on %s", addr)
			s.Run()
			return nil
		},
	}
...
func ensureTLS() (*tls.Config, error) {
	resDir := "/home/hp/UMBRA/Umbra-Server/umbra-c2/app/umbra-c2/resource"
	...
	fmt.Printf("\033[1;32m[+] TLS certificate saved to app/umbra-c2/resource/%s and app/umbra-c2/resource/%s\033[0m\n",
		certFile, keyFile)
